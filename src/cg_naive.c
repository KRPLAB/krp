 ...
 */
double *gradiente_conjugado(const struct matriz_banda *a, const double *x, double *r, const double *d) {
	// z = A * d
 ...
 */
int cg_solve(const struct matriz_banda *a, const double *b, double *x, double tol, int max_iter) {
	int n = a->linhas;
	int iter = 0;
